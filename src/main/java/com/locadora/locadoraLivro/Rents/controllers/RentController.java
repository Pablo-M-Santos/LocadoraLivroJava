...
public class RentController {
    ...
    @PutMapping("/rent/{id}")
    public ResponseEntity<Object> update(@PathVariable("id") int id, @RequestBody @Valid UpdateRentRecordDTO updateRentRecordDTO) {
        return rentServices.update(id, updateRentRecordDTO;
    }
